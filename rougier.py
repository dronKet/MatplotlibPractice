...
def task4():
    ...
    #plt.fill_between(X,-1,Y-1, where=y2 >= y1, facecolor='green', interpolate=True)
    plt.fill_between(X,1,Y+1,facecolor='blue')
    plt.fill_between(X,-1,Y-1,facecolor='blue')
    plt.fill_between(X,-1,Y-1, where=-1 >= Y-1, facecolor='red', interpolate=True)
